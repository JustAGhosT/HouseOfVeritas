...
5. Check for architectural anti-patterns (circular deps, god modules, tight coupling)
6. Write your findings to `.claude/reports/architecture-report.md` with mermaid diagrams
7. Return a brief summary of architectural concerns

Focus on: system design coherence, integration patterns, scalability, and maintainability.

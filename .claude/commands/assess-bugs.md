...
5. Classify each finding as BUG, FEATURE, or ENHANCEMENT with severity P0-P3
6. Write your findings to `.claude/reports/bugs-enhancements-report.md`
7. Return a brief summary of critical bugs and top feature gaps

Focus on: security vulnerabilities, data integrity risks, and missing core features.
